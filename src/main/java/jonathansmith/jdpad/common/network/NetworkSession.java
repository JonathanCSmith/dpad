...
import jonathansmith.jdpad.common.network.listener.PacketListenersTuple;
...
public abstract class NetworkSession extends SimpleChannelInboundHandler {
    ...
    public NetworkSession(Engine engine, boolean isClientSide) {
        this.engine = engine;
    ...
    public void setConnectionState(ConnectionState state) {
        ...
        this.channel.attr(WHITELISTED_RECEIVABLE_PACKETS_ATTRIBUTE_KEY).set(state.getSideSpecificWhitelistedPackets(this.isClientSide));
        this.channel.attr(WHITELISTED_SENDABLE_PACKETS_ATTRIBUTE_KEY).set(state.getSideSpecificWhitelistedPackets(this.isClientSide));
