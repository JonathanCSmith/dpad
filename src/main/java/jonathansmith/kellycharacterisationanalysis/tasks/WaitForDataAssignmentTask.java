 ...
 */
public class WaitForDataAssignmentTask implements IPluginTask, IEventListener {
    ...
    private static final String TASK_NAME = "Wait for data assignment";
    ...
    public WaitForDataAssignmentTask(KellyCharacterisationAnalysis kellyCharacterisationAnalysis) {
    ...
    public void onEventReceived(Event event) {
        ...
        this.core.setDataMasks(((KellyDataAssignmentFinishEvent) event).getOrdererdMasks());
    }
}
